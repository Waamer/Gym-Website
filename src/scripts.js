...
function generateMap() {
  ...
  initMap(locationInput, radiusInput); // pass locationInput and radiusInput as arguments to initMap
}

function initMap(locationInput, radiusInput) { // Initialize and add the map
